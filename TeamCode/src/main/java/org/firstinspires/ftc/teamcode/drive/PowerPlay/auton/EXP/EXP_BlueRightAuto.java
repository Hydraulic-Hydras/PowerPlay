...
@Autonomous
public class EXP_BlueRightAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence cycle1 = drive.trajectorySequenceBuilder(preload.end())
                .setVelConstraint(SampleMecanumDrive.getVelocityConstraint(50, Math.toRadians(180), DriveConstants.TRACK_WIDTH))
                .setAccelConstraint(SampleMecanumDrive.getAccelerationConstraint(50))

                .UNSTABLE_addTemporalMarkerOffset(1, () -> {
                    lift_L.setTargetPosition(247);
                    lift_L.setPower(0.85);
                    lift_L.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    lift_R.setTargetPosition(236);
                    lift_R.setPower(0.85);
                    lift_R.setMode(DcMotor.RunMode.RUN_TO_POSITION);

                })

                .lineToLinearHeading(new Pose2d(-35, 14.5, Math.toRadians(270)))

                .resetConstraints()
                .addTemporalMarker(0.7, () -> {
                    turret.setTargetPosition(1244);
                    turret.setPower(0.8);
                    turret.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                })


                .lineTo(new Vector2d(-61.5, 14.3),
                        SampleMecanumDrive.getVelocityConstraint(65, Math.toRadians(180), DriveConstants.MAX_ANG_VEL),
                        SampleMecanumDrive.getAccelerationConstraint(45))

                .UNSTABLE_addTemporalMarkerOffset(0.5, () -> CLAW.setPosition(grab))
                .waitSeconds(0.5)
                ...
                .lineTo(new Vector2d(-21.5, 13.4),
                        SampleMecanumDrive.getVelocityConstraint(45, Math.toRadians(180), DriveConstants.MAX_ANG_VEL),
                        SampleMecanumDrive.getAccelerationConstraint(45))
                .waitSeconds(.7)
                .forward(1)
        ...
        TrajectorySequence park = drive.trajectorySequenceBuilder(cycle5.end())
