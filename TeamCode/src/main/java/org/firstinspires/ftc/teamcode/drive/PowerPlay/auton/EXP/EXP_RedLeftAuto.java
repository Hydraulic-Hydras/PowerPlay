...
@Autonomous
public class EXP_RedLeftAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence cycle1 = drive.trajectorySequenceBuilder(preload.end())
                ...
                .UNSTABLE_addTemporalMarkerOffset(1.2, () -> {
                    lift_L.setTargetPosition(335);
                    lift_L.setPower(0.75);
                    lift_L.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    lift_R.setTargetPosition(290);
                    lift_R.setPower(0.75);
                    lift_R.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                ...
                .UNSTABLE_addTemporalMarkerOffset(0.2, () -> {
                    turret.setTargetPosition(-1186);
                    turret.setPower(0.70);
                    turret.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                })


                .lineTo(new Vector2d(-63, -14),
                        SampleMecanumDrive.getVelocityConstraint(30, Math.toRadians(180), DriveConstants.MAX_ANG_VEL),
                ...
                .UNSTABLE_addTemporalMarkerOffset(0.5, () -> {
                    turret.setTargetPosition(-63);
                    turret.setPower(0.65);
                    turret.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                })

                .lineTo(new Vector2d(-21, -13))
                .UNSTABLE_addTemporalMarkerOffset(0.8, () -> CLAW.setPosition(open))
